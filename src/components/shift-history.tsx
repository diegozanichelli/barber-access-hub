...
function DifferenceValue({ value, isBad }: { value: number | null; isBad: boolean }) {
              ...
              {shifts.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <DifferenceValue value={shiftDiff} isBad={shiftBad} />
                    </td>
                    <td className="py-3 pr-3">
                    ...
                    >
                      <DifferenceValue value={handoverDiff} isBad={handoverBad} />
                    </td>
                    <td className="py-3">
