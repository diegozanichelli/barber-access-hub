-- Roda depois que a adição do enum efetivou, para o PostgreSQL conseguir
-- resolver o literal 'Produtos' ao compilar a função.
...
BEGIN
  ...
  IF NEW.transaction_type = 'income' THEN
    IF NEW.category NOT IN ('Bebida', 'Assinatura Nova', 'Renovação', 'Upgrade', 'Serviços', 'Produtos')
