-- Add the Cellcoins modality and align receipt requirements with operations:
-- Pix income and every cash outflow require evidence; other income modalities do not.
ALTER TYPE public.payment_method ADD VALUE IF NOT EXISTS 'Cellcoins';
